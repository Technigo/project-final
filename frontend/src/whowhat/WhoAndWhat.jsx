          ...
          <div className="draw-info-child">
            ...
            <div className="text">
              <p>
                ...
                epic quests to everyday adventures. Whether you're crafting a
                new protagonist for your story or seeking inspiration for your
                visual storytelling, our generator offers the creative spark you
                need. Prepare to be enthralled by the diverse cast of
                characters, each embarking on their own journey, from daring
                escapades to heartfelt encounters. Ignite your creativity with
                our random character and action generator, and explore a realm
                filled with infinite storytelling possibilities!
              </p>
            </div>
