  ...
  return (
    <div className="questionContainer">
      ...
      <div className="questionsWrapper">
        ...
        <p className="answer">
          When you have made your order you will get an email where you confirm
          at which time the delivery of the rentals would be fitting for you
        </p>
        ...
        <p className="answer">
          If the item you are renting would break you should contact us as quick
          as possible on our email.
        </p>
      </div>
    </div>
  );
