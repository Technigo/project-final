...
const getTitleMessage = () => {
  ...
  const getDescriptionMessage = () => {
    if (paymentSuccessful) return "This website is a test e-commerce, thank you for trying it out."
  ...
  console.log("message comp", paymentSuccessful)

  return (
    <div className="fixed top-0 left-0 w-full h-full bg-overlay backdrop-blur-sm flex items-center justify-center z-50">
      <div className="w-fill my-20 rounded-lg bg-login border-main-red border-opacity-50 backdrop-blur-sm p-8 relative flex justify-between">
